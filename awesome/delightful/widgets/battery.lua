...
local config_description = {
	{
		name     = 'battery',
		required = true,
-- um, I changed the default.  Because that was easiest.  So I'll have to change it again when I move this script to another machine.
		default  = 'BAT0',
